...
//	});
//})
$(".slider_D4").slick({slidesToShow:4,slidesToScroll:4,dots:!1,arrows:!0,speed:500,infinite:false,
...
$(".slider_D3").slick({slidesToShow:3,slidesToScroll:3,dots:!1,arrows:!0,speed:500,infinite:false,
    responsive: [{breakpoint:850,settings:{slidesToShow:2,slidesToScroll:2}},
    			{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1,centerMode:true,centerPadding:'10px',infinite:true}}]
});
